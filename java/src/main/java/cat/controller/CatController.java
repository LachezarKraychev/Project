...
public class CatController {
    ...
    public String createProcess(Model model, CatBindingModel catBindingModel) {
        ...
        Cat project = new Cat();
        project.setName(catBindingModel.getName());
        project.setNickname(catBindingModel.getNickname());
        project.setPrice(catBindingModel.getPrice());

        catRepository.saveAndFlush(project);
